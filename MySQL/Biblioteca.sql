...
(1, 1, 1, '2024-05-10', '2025-01-18'),
(2, 2, 3, '2026-01-15', '2026-02-15'),
(3, 3, 1, '2024-03-01', '2024-03-20'),
(4, 4, 2, '2025-04-10', '2025-05-10'),
(5, 1, 4, '2025-06-01', NULL),
(6, 5, 2, '2024-02-10', '2024-03-01'),
(7, 6, 5, '2025-03-15', '2025-04-10'),
(8, 7, 6, '2026-04-01', '2026-04-20'),
(9, 8, 7, '2024-05-05', '2024-05-25'),
(10, 9, 8, '2025-06-10', NULL),
(11, 10, 9, '2026-01-20', '2026-02-05'),
(12, 11, 10, '2024-02-14', '2024-03-14'),
(13, 12, 3, '2025-03-22', '2025-04-12'),
(14, 13, 4, '2026-04-18', '2026-05-02'),
(15, 14, 11, '2024-05-25', NULL);
...
SELECT DISTINCT Libro.titolo FROM Biblioteca.Libro JOIN Biblioteca.Prestito ON libro.id_utente = prestito.id_libro WHERE prestito.data_prestito LIKE '2026%';
SELECT * FROM Biblioteca.Prestito JOIN Biblioteca.Utente ON Prestito.id = Utente.cf WHERE Utente.email = 'nicolo.rossi@gigi.com';
